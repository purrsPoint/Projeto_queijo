    ...
    <nav class="topo">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php"><img src="images/Queijo_logo.png"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="pagina4.php">Próximo></a>
                        </li>
    ...
    <div class="conteudo">
        ...
        <div class="bloco">
            ...
            <h2 class="texto-card">
                ...
                mescla,
                de vários tipos de queijo besuntados com corante.
            </h2>
